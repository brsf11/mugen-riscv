...
# @Desc      :   Using encrypted SMB 3.0 connection to mount share
# #############################################
...
function run_test() {
    ...
    mount -t cifs -o username=testsamba,password=${NODE1_PASSWORD},seal,vers=3 //${NODE2_IPV4}/testsamba /home/client
    CHECK_RESULT $?
