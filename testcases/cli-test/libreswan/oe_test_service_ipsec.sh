...
# @Desc      :   Test ipsec.service restart
# #############################################
...
function run_test() {
    ...
    CHECK_RESULT $? 0 0 "ipsec.service reload failed"
    systemctl status ipsec.service | grep "Active: active"
    CHECK_RESULT $? 0 0 "ipsec.service reload causes the service status to change"
