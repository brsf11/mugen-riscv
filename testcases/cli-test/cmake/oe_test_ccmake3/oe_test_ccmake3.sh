...
# @Desc      :   verify the uasge of ccmake3 command
# ############################################
...
function run_test() {
    ...
    ccmake3 -help | grep -E "Usage|ccmake <path-to-source>"
    CHECK_RESULT $?
    ccmake3 -version | grep "ccmake version"
    CHECK_RESULT $?
    ccmake3 --help-full | grep "variable"
    CHECK_RESULT $?
    ccmake3 --help-command add_executable | grep "add_executable"
    CHECK_RESULT $?
