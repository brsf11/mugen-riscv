...
# @Desc      :   Test mcstrans.service restart
# #############################################
...
function run_test() {
    ...
    journalctl --since "${log_time}" -u "${service}" | grep -i "fail\|error" | grep -v -i "DEBUG\|INFO\| WARNING" | grep -v "initialize color translations"
