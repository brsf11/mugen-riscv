...
EOF
    echo "This is to test the rsync function of lsyncd" >>/var/source_dir/test.lua
...
function run_test() {
    ...
    CHECK_RESULT $? 0 0 "This is to test the rsync function of lsyncd"
